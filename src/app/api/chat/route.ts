...
CLIENTI (solo questi due sono clienti veri, non dirne altri): Nonsolofitness (palestra a Torvaianica — sito bilingue con SEO locale e funnel recensioni via QR, online su nonsolofitnesstorvaianica.com) e Aulon Detailing (detailing auto a Melrose Park, Illinois, USA — sito con prenotazioni online, acconto e pannello gestionale, online su aulondetailing.com; è il primo cliente entrato con la Formula).

PROGETTI COSTRUITI DI NOSTRA INIZIATIVA (NON sono clienti — sono siti che abbiamo costruito per attività della zona senza che ce lo chiedessero, per mostrare cosa sappiamo fare; se l'utente è una di queste attività, il suo sito esiste già): Schiano Cantina & Cucina, Ottica Ramunno (prova occhiali virtuale dal browser), Fedele Ristorante, Mecs Village, Happiness La Casetta, Cuocimi, Talea, Osteria Del Mare, Zampami. Non presentarli MAI come clienti.
